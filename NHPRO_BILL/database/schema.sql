-- ============================================================
-- NH PRODUCTION NHPRO_BILL - DATABASE SCHEMA
-- Database: MariaDB / MySQL 8+
-- Compatible with FreeRADIUS raddb/mods-config/sql/main/mysql
-- ============================================================

CREATE DATABASE IF NOT EXISTS nhpro_bill_radius CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE nhpro_bill_radius;
...
('admin', 'Super Admin', 'admin@billing.id', '$2a$10$8.Xb/R/QJz/40/t0f0gS0.G06yV50l9QWb9V2xN1c5N87B1/6U32W', 'superadmin');
