#!/usr/bin/env bash
# =============================================================================
#  NHPRO_BILL — Update Script
#  Jalankan: wget -qO- https://raw.githubusercontent.com/idpanyoet/NHPRO_BILL-Project/master/update.sh | sudo bash
#
